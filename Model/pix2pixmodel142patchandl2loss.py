# -*- coding: utf-8 -*-
"""pix2pixmodel142patchandL2loss.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yqPQX0O1d6dnnyxvGm1HqH1_HG5OQSIG
"""
...
def summarize_performance(step, g_model, dataset, n_samples=3):
	...
	# save plot to file
	filename1 = '/kaggle/working/plot_%06d.png' % (step + 1)
	plt.savefig(filename1)
	plt.close()
	# save the generator model
	filename2 = '/kaggle/working/model_%06d.h5' % (step + 1)
	g_model.save(filename2)
	print('>Saved: %s and %s' % (filename1, filename2))
 # Update the paths for saving plots and models
# Update the paths for saving plots and models
